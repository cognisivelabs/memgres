...
public interface AstVisitor<T, C> {
    ...
    T visitCreateMaterializedViewStatement(CreateMaterializedViewStatement node, C context) throws Exception;
    T visitDropMaterializedViewStatement(DropMaterializedViewStatement node, C context) throws Exception;
    T visitRefreshMaterializedViewStatement(RefreshMaterializedViewStatement node, C context) throws Exception;
    ...
    T visitCreateSchemaStatement(CreateSchemaStatement node, C context) throws Exception;
    T visitDropSchemaStatement(DropSchemaStatement node, C context) throws Exception;
    T visitSetStatement(SetStatement node, C context) throws Exception;
    T visitExplainStatement(ExplainStatement node, C context) throws Exception;
